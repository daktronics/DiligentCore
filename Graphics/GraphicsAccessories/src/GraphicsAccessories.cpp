...
#define INIT_TEX_VIEW_FORMAT_INFO(TexFmt, SRVFmt, RTVFmt, DSVFmt, UAVFmt)\
        ...
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_AYUV, R8_UNORM, UNKNOWN, UNKNOWN, UNKNOWN);
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_Y410, R8_UNORM, UNKNOWN, UNKNOWN, UNKNOWN);
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_Y416, R8_UNORM, UNKNOWN, UNKNOWN, UNKNOWN);
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_NV12, R8_UNORM, UNKNOWN, UNKNOWN, UNKNOWN);
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_P010, R8_UNORM, UNKNOWN, UNKNOWN, UNKNOWN);
...
#define INIT_TEX_FORMAT_INFO(TexFmt, ComponentSize, NumComponents, ComponentType, IsTypeless, BlockWidth, BlockHeight) \
            ...
            INIT_TEX_FORMAT_INFO(TEX_FORMAT_AYUV, 1, 1, COMPONENT_TYPE_UNORM, false, 1, 1);
            INIT_TEX_FORMAT_INFO(TEX_FORMAT_Y410, 1, 1, COMPONENT_TYPE_UNORM, false, 1, 1);
            INIT_TEX_FORMAT_INFO(TEX_FORMAT_Y416, 1, 1, COMPONENT_TYPE_UNORM, false, 1, 1);
            INIT_TEX_FORMAT_INFO(TEX_FORMAT_NV12, 1, 1, COMPONENT_TYPE_UNORM, false, 1, 1);
            INIT_TEX_FORMAT_INFO(TEX_FORMAT_P010, 1, 1, COMPONENT_TYPE_UNORM, false, 1, 1);

#undef  INIT_TEX_FORMAT_INFO
            // clang-format on
            static_assert(TEX_FORMAT_NUM_FORMATS == 111, "Not all texture formats initialized.");
...
{
    static_assert(TEX_FORMAT_NUM_FORMATS == 111, "Please update the switch below to handle the new texture format, if needed");
    switch (Fmt)
    {
